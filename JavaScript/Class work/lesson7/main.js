...
//     };
// }
// let addCar = new Cars('Skoda', 'Czech', 2013, 270, 1.6);
// console.log(addCar);
// addCar.drive();
// addCar.info();
...
// }
//
// let addCar2 = new Cars2('Skoda', 'Czech', 2013, 270, 1.6);
// console.log(addCar2);
// addCar2.drive();
// addCar2.info();
...
const popelushkaArray = [
    new Popelushka('alina', 22, 38),
    new Popelushka('ivanka', 21, 25),
    new Popelushka('natasha', 24, 30),
    new Popelushka('anya', 26, 31),
    new Popelushka('vika', 29, 32),
    new Popelushka('gelya', 90, 58),
    new Popelushka('oksana', 87, 34),
    new Popelushka('kcyha', 34, 39),
];
...
const prince = new Princ('Misha', 45, 38);
